...
import com.repoai.currencypro.CurrencySingleton.bgColor
...
class HomeActivity : AppCompatActivity() {
    ...
    private fun alertDialogAppVersion() {
        ...
        mBuilder.setTitle("version 1.0.0")
        mBuilder.setMessage("CurencyPro uses shekel as default currency (NIS)")
