...
class WebActivity : AppCompatActivity() {
    ...
    private fun showWebData(){
        ...
        for(i in 0 until currList.size){
            ...
            htmlDocument+="<ul><li>Currency : ${currList.get(i).CURRENCYCODE}</li><li>Rate : ${currList.get(i).RATE} </li><li>Variations : ${currList.get(i).CHANGE}</li></ul>"
        }
